...
Tovar::Tovar()
{
    naimenovanie=""; kolichestvo=0; stoimost=0;
...
{
    naimenovanie=N; kolichestvo=K; stoimost=S;
...
{
    naimenovanie=t.naimenovanie; kolichestvo=t.kolichestvo; stoimost=t.stoimost;
...
void Tovar::show()
{
    cout<<"naimenovanie :"<<naimenovanie<<endl; cout<<"kolichestvo :"<<kolichestvo<<endl; cout<<"stoimost :"<<stoimost<<endl;
}
